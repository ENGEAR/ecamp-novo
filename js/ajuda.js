  ...
  function html() {
    ...
    return (
      ...
      topico('🧳 Tipos de reembolso', ul([
        ...
        '📦 <strong>Outros do Serviço:</strong> opção para solicitar o reembolso ou pagamento de despesas do serviço não cobertas pelos outros tipos, como abastecimento, peças, manutenção, pedágios e outros custos associados.'
      ])) +
