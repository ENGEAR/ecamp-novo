...
- **Outro (genérico) — PRONTO.** Geral: tipo de monitoramento (texto), objetivo, qtde de pontos. Por ponto: nome, GPS, hora inicial, medição principal + unidade, foto da tela + foto do ponto, clima (com alerta de vento ≥ 5 m/s), observações. Equipamentos = cadastro manual.
